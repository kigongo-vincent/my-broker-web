...
static getFullyQualifiedName(): "mybroker.Location" {
  return 'mybroker.Location';
}
...
static createLocation(builder:flatbuffers.Builder, lat:number, lon:number, nameOffset:flatbuffers.Offset):flatbuffers.Offset {
